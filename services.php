...
<html lang="en">
  <head>
    <title>Glitz and Glamup-Services</title>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5">
            <h2 class="mb-0 bread" style="color: black;">Services</h2>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php" style="color: black;">Home <i class="ion-ios-arrow-forward"></i></a></span> <span style="color: black;">Services <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
