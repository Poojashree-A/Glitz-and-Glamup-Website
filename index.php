...
<html lang="en">
  <head>
    <title>Glitz and Glamup||Home Page</title>
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/lg.jpg);" data-stellar-background-ratio="0.5">
	          ...
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" >
		          	<div class="">
			            ...
			            <p class="mb-4" style="color: white;">We pride ourselves on our high quality work and attention to detail. <br>The products we use are of top quality branded products.</p>
	          ...
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="">
			            ...
			            <p class="mb-4" style="color: white;">This parlour provides huge facilities with advanced technology <br>equipments and best quality service. Here we offer best <br>treatment that you might have never experienced before.</p>
